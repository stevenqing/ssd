...
import random
from social_dilemmas.envs.agent import Coin5Agent
from social_dilemmas.envs.gym.discrete_with_dtype import DiscreteWithDType
from social_dilemmas.envs.map_env import MapEnv
from social_dilemmas.maps import COIN5_MAP
...
class Coin5Env(MapEnv):
    ...
    def setup_agents(self):
        ...
        for i in range(self.num_agents):
            ...
            agent = Coin5Agent(agent_id, spawn_point, rotation, grid, COIN_VIEW_SIZE)
