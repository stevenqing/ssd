...
class ChannelAttention(BaseFeaturesExtractor):
...
class SpatialAttention(BaseFeaturesExtractor):
...
class CBAM(BaseFeaturesExtractor):
    def __init__(self, channel, view_len=7, num_frames=6, fcnet_hiddens=[1024, 128], reduction=16, kernel_size=7):
        super().__init__()
