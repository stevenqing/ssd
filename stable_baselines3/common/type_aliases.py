...
class SocialRolloutBufferSamples(NamedTuple):
    observations: th.Tensor
    actions: th.Tensor
    old_values: th.Tensor
    old_log_prob: th.Tensor
    ...
    all_rewards: th.Tensor
    cf_rewards: th.Tensor
    advantages_m: th.Tensor
    advantages_e: th.Tensor
    returns_m: th.Tensor
    returns_e: th.Tensor

class TransitionRolloutBufferSamples(NamedTuple):
    observations: th.Tensor
    actions: th.Tensor
    old_values: th.Tensor
    old_log_prob: th.Tensor
    ...
    all_actions: th.Tensor
    all_rewards: th.Tensor
    all_next_obs: th.Tensor
    all_next_actions: th.Tensor
    all_next_rewards: th.Tensor
    cf_rewards: th.Tensor
...
class RewardTrajsRolloutBufferSamples(NamedTuple):
    ...
    cf_rewards: th.Tensor
    all_obs_traj: list
    all_action_traj: list
    all_rewards_traj: list
    # prev_obs_traj: list
    # prev_action_traj: list
    # prev_rewards_traj: list
    all_dones: th.Tensor
    traj_length: list
